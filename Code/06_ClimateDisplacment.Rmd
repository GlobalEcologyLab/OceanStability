...
# Create the hovmoller plot that gets stacked in the corner
...
fig04 <- ggdraw(fig04) +
  ...
  draw_plot(hco_search + 
              theme(plot.background = element_rect(fill = "#FFFFFF", colour = NA),
                    legend.margin = margin(-0.75, 0, 0, 0, unit = "lines")),
            width = 0.18, height = 0.3, x = 0.002, y = 0.027) +
  draw_plot_label(label = "b", x = 0.01, y = 0.37, size = 14)

# save to PDF
ggsave(filename = "Figure04.pdf", plot = fig04,
       device = cairo_pdf, path = "Figures",
      width = 14, height = 8.46, units = "in", dpi = 350)

# save to PNG for MS
ggsave(filename = "Figure04.png", plot = fig04,
       device = "png", type = "cairo", path = "Figures",
       bg = "white", width = 14, height = 8.46, units = "in", dpi = 350)
