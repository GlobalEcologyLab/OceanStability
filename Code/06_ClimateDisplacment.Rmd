...
# save to PNG for MS
ggsave(filename = "Figure4.png", plot = figS5,
       device = "png", type = "cairo", path = "Figures",
       bg = "white", width = 5, height = 6.5, units = "in", dpi = 350)
...
fig04 <- ggplot() +
  ...
  theme(legend.position = "bottom",
        ...
        legend.direction = "horizontal")
# save to PDF
ggsave(filename = "Figure04.pdf", plot = fig04,
       device = cairo_pdf, path = "Figures",
       width = 7, height = 5, units = "in", dpi = 350)

# save to PNG for MS
ggsave(filename = "Figure04.png", plot = fig04,
       device = "png", type = "cairo", path = "Figures",
       bg = "white", width = 7, height = 5, units = "in", dpi = 350)

# plot
fig04 + labs(caption = "Figure 4 - Dispersal from hotspot locations to climate analogues under RCP 4.5 and RCP 8.5 restricted to EEZ")
```
