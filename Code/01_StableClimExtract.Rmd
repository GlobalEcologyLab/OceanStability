...
ocean_mask <- ne_download2(scale = 50, type = "ocean", category = "physical",
                          destdir = file.path(outDir, "/outputs"), load = TRUE,
                          returnclass = "sf")
...
writeRaster(pal_rast_sub$ocn_warm,
            filename = file.path(outDir, "outputs/paleo_rasters_ocean_warming.grd"),
            datatype = "FLT4S", overwrite = TRUE)
writeRaster(rcp45_rast_sub$ocn_warm,
            filename = file.path(outDir, "outputs/rcp45_rasters_ocean_warming.grd"),
            datatype = "FLT4S", overwrite = TRUE)
writeRaster(rcp85_rast_sub$ocn_warm,
            filename = file.path(outDir, "outputs/rcp85_rasters_ocean_warming.grd"),
            datatype = "FLT4S", overwrite = TRUE)
```
...
writeRaster(snr_deltaRCP45$Delta_stSNR_ocn_warm[["Delta_stSNR_ocn_warm"]],
            file.path(outDir, "outputs/snr_st_delta_rcp45.tif"), overwrite = TRUE)
writeRaster(snr_deltaRCP85$Delta_stSNR_ocn_warm[["Delta_stSNR_ocn_warm"]],
            file.path(outDir, "outputs/snr_st_delta_rcp85.tif"), overwrite = TRUE)
```
